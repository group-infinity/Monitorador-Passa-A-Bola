  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        bpm: {
          low: "hsl(var(--bmp-low))",
          normal: "hsl(var(--bmp-normal))",
          elevated: "hsl(var(--bpm-elevated))",
          high: "hsl(var(--bmp-high))",
        },
        sidebar: {
      ...
      boxShadow: {
        ...
        'glow-primary': '0 0 40px hsl(271 91% 65% / 0.4)',
        'glow-accent': '0 0 40px hsl(192 91% 65% / 0.3)',
        'elevation': '0 8px 32px hsl(224 30% 5% / 0.5)',
        'card': '0 4px 20px hsl(224 30% 5% / 0.3)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
